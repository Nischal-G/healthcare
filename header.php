...
<head>
<title>Online Health Record Management System</title>
...
<div class="wrapper col1" style="background-color: #0AABD7">
  <div id="head"><br>
    <center><h1>Online Health Record Management System</h1></center>
    <div id="topnav" style="background-color: #0AABD7">
      <ul>
